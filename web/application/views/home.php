...
<!--
    <div class="container" id="p_android_panel">
		<div class="jumbotron" id="android_panel">
			<div class="container">
				<div class="col-md-6 col-xs-12">
					<h2>Estamos disponíveis na PlayStore</h2>
					<p>FastHelp está disponível para a maioria dos 
					dispositivos móveis do mundo! Baixe já.</p>
					<a target="_blank" href="https://play.google.com/store/apps/details?id=br.edu.ifrn.fh"><img src="public/img/badge.png"></a>
				</div>
				<div class="col-md-6 hidden-sm hidden-xs" id="cell">
					<center><img src="public/img/cell.png"></center>
				</div>
			</div>
		</div>
    </div>
	...
	<div class="container hidden-sm hidden-xs">
		<div>
			<div id="myCarousel" class="carousel slide" data-ride="carousel" data-interval="false">
			  ...
			  <!-- Wrapper for slides -->
			  <div class="carousel-inner" role="listbox" style="background: #15a689;">																																										
				<div class="item active">
					<center><img src="public/img/slide/01.png"></center>
				</div>

				<div class="item">
				  <center><img src="public/img/slide/02.png"></center>
				</div>

				<div class="item">
				  <center><img src="public/img/slide/03.png"></center>
				</div>

				<div class="item">
				  <center><img src="public/img/slide/04.png"></center>
				</div>
			  </div>
