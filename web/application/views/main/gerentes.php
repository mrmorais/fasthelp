                  ...
                  <div class="col-lg-12">
							...
							<table class="table">
								...
								<?php
									foreach ($gerentes as $gerente) {
										...
										echo "<td>".$gerente['sobrenome']."</td>";
										echo "<td>".$gerente['email']."</td>";
										if ($gerente['id']!=$user['id']) {
											echo "<td><a href='?/Main/gerentes/delete/".$gerente['id']."'><button class='btn btn-danger'><i class='fa fa-trash-o'></i> deletar</button></a></td>";
										} else {
											echo "<td><a href='?/Main/configura_gerente/encerrar'><button class='btn btn-danger'><i class='fa fa-trash-o'></i> encerrar conta</button></a></td>";
										}
										echo "</tr>";
									}
								?>
					  ...
					  <div class="panel">
						<div class="panel-body">
							...
							<form class="form" method="post" action="?/Main/gerentes/cadastrar">
								<div class="col-md-8">
									<div class="form-group col-md-6">
										<label>Nome</label>
										<input type="text" class="form-control" name="nome" value="<?php set_value('nome'); ?>" required>
									</div>
									<div class="form-group col-md-6">
										<label>Sobrenome</label>
										<input type="text" class="form-control" name="sobrenome" required value="<?php set_value('sobrenome'); ?>">
									</div>
									<div class="form-group col-md-12">
										<label>Email</label>
										<input type="email" class="form-control" name="mail" required value="<?php set_value('mail'); ?>">
									</div>
								</div>
								<div class="col-md-4">
									<p class="text-justify">O cadastro de um novo gerente dá a ele os mesmos direitos que o gerente inicial
									possui. Portanto, tenha muito cuidado ao emitir uma nova conta de acesso!</p>
									<p class="text-justify">Ao clicar em "Enviar formulário" você concorda que o <b>fastHelp</b> não repara danos causados
									pelos gerentes cadastrados por você.</p>
									<button type="submit" class="btn btn-success form-control">Enviar formulário</button>
								</div>
							</form>
