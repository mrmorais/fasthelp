                  ...
                  <div class="col-lg-12">
					  ...
					  <div class="panel">
						<div class="panel-body">
							...
							<form class="form" method="post" action="?/Main/configura_gerente/dados/confirmar">
								<div class="col-md-8">
									...
									<div class="form-group col-md-6">
										...
										<input type="text" class="form-control" name="sobrenome" value="<?php echo $user['sobrenome']; ?>" required>
									</div>
									<div class="form-group col-md-12">
										<label>E-mail</label>
										<input type="email" class="form-control" name="mail" value="<?php echo $user['email']; ?>" required>
									</div>
									<div class="form-group col-md-12">
										<button class="btn btn-success form-control" type="submit">Enviar formulário</button>
									</div>
								</div>
								<div class="col-md-4">
									<p class="text-justify">Talvez você queira alterar sua senha de acesso, ou
										encerrar sua conta pessoal.</p>
									<div class="form-group">
										<a href="?/Main/configura_gerente/senha" class="btn btn-danger form-control">Alterar senha</a>
									</div>
									<div class="form-group">
										<a href="?/Main/configura_gerente/encerrar" class="btn btn-danger form-control">Encerrar conta</a>
									</div>
								</div>
							</form>
					  ...
					  <div class="panel">
						<div class="panel-body">
							<h4>Alterar senha</h4>
							<?php echo validation_errors(); ?>
							<form class="form" method="post" action="?/Main/configura_gerente/senha/confirmar">
								<div class="col-md-8">
									<div class="form-group col-md-12">
									...
									<div class="form-group col-md-6">
										...
										<input type="password" class="form-control" name="senha_nova" maxlength="45" required>
									</div>
									<div class="form-group col-md-6">
										<label>Nova senha novamente</label>
										<input type="password" class="form-control" name="senha_nova_r" maxlength="45" required>
									</div>
									<div class="form-group col-md-12">
										<button class="btn btn-success form-control" type="submit">Enviar formulário</button>
									</div>
								...
								<div class="col-md-4">
									<p class="text-justify"><b>Lembre-se!</b> Caso você esqueça a sua senha solicite uma nova senha na área de login.</p>
								</div>
							</form>
					  ...
					  <?php } ?>
					  <?php if ($area == "encerrar") { ?>
					  <div class="panel">
						<div class="panel-body">
							<h4>Encerrar conta</h4>
							<form class="form" method="post" action="?/Main/configura_gerente/encerrar/confirmar">
								<div class="col-md-4">
									<p class="text-justify">Você tem certeza do que está fazendo?</p>
									<p class="text-justify">O <b>fastHelp</b> não oferece mecanismos que permitam a recuperação
									de sua conta. Se esta conta é a única cadastrada junto ao órgão, a conta do órgão também será
									encerrada. Isso significa que o serviço no <b>fastHelp</b> para este órgão será desabilitado,
									e o órgão não poderá atender chamados. Da mesma forma, o perfil do órgão, assim como todas os
									registros de postagens nele serão excluídos.</p>
									<p class="text-justify">Caso o órgão possua, ainda, outros gerentes já cadastrados, a conta do
									órgão não será prejudicada.</p>
									<p class="text-justify">Se você desejar, em outro momento retomar o serviço no <b>fastHelp</b>
									terá que solicitar um cadastramento à outro gerente. Se a conta do órgão também for encerrada,
									você deverá fazer o pré-cadastro e passar pela etapa de avaliação.</p>
								...
								<div class="col-md-6">
									...
									<div class="form-group">
										<button type="submit" class="btn btn-danger form-control">Confirmar encerramento</button>
									</div>
								</div>
