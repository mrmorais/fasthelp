      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
		  <section class="wrapper">
			  <div class="row">
                  <div class="col-lg-12">
					  <h2>Estamos trabalhando em algo aqui!</h2>
					  <div class="panel">
						<div class="panel-body">
							<div class="row">
								<div class="col-lg-3"><img width="100%" src="public/img/neep.png"></div>
								<div class="col-lg-8">
									<h4>Adotamos a ideia <b>"<?php echo $ideia['titulo']; ?>"</b>:</h4><hr>
									<h4 class="text-justify"><b><?php echo $ideia['descricao']; ?></b></h4><hr>
									<h4>Sua colaboração é muito importante, deixe sua Ideia ou Feedback clicando no ícone
									<img src="public/img/ideia.png"> no canto da sua tela.</h4>
								</div>
							</div>
						</div>
					  </div>
