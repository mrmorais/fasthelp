					  ...
					  <div class="panel">
						<div class="panel-body">
							...
							<div class="row">
								...
								?>
								<div class="col-md-4 chamado">
									<div class="row">
										<div class="col-xs-4">
											<img src="<?php echo $atendimento['image']; ?>" width="100%">
											<a href="?/Main/chamado/<?php echo $atendimento['id']; ?>"><button class="btn btn-danger form-control">Ver</button></a>
										</div>
										<div class="col-xs-8">
											<b><h4><?php echo $atendimento['titulo']; ?></h4></b><br>
											Localização: <?php echo $atendimento['endereco']; ?>
										</div>
									</div>
								</div><!--/.col-->
								<?php } ?>
						...
						<div class="panel-body">
							...
							<div class="row">
								...
								<div class="col-md-4 chamado">
									<div class="row">
										<div class="col-xs-4">
											<img src="<?php echo $chamado['image']; ?>" width="100%">
											<a href="?/Main/chamado/<?php echo $chamado['id']; ?>"><button class="btn btn-danger form-control">Ver</button></a>
										</div>
										<div class="col-xs-8">
											<b><h4><?php echo $chamado['titulo']; ?></h4></b><br>
											Localização: <?php echo $chamado['endereco']; ?>
										</div>
									</div>
								</div><!--/.col-->
								<?php } ?><!--//Chamados-->
