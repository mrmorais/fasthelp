			  ...
			  <div class="row">
                  <div class="col-lg-12">
					  ...
					  <div class="panel">
						<div class="panel-body">
							<h4>Funções</h4>
							<form class="form" method="post" action="?/Main/configura_orgao/funcoes/confirmar">
								<div class="row">
								<?php
									foreach($funcoes as $funcao) {
										echo "<div class='col-md-3 text-center'>";
										echo "<img src='".$funcao['icone']."'><br>";
										echo "<label><input type='checkbox' name='funcao[]' value='".$funcao['codigo']."' ".$funcao['checked'].">".$funcao['descricao']."</label>";
										echo "</div>";
									}
								?>
								</div>
